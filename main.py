...
if wikipedia_login.login():
    ...
    df_us_states = us_extractor.extract_us_states_data()
    df_etimologia = us_extractor.extract_etimologia(df_us_states)
    us_extractor.save_to_excel(df_us_states, df_etimologia)
